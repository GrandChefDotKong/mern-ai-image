...
const CreatePost = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await fetch('https://ai-image-generator-bkta.onrender.com/api/v1/post', {
        method: 'POST',
  ...
  const generateImage = async () => {
    ...
    try {
      ...
      const response = await fetch('https://ai-image-generator-bkta.onrender.com/api/v1/dalle', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
      ...
      <div>
        <div>
          ...
          <p className="mt-2 text-[#66e75] text-[16px] max-w-[500px]">
            Create imaginative 
            and stunning images generated by DALL-E AI
          </p>
        </div>
        <form onSubmit={handleSubmit} className="mt-16 max-w-3xl">
          <div className="flex flex-col gap-5">
            ...
            border-grey-300 text-grey-900 text-sm rounded-lg focus:ring-blue-500 
            ...
            >
              ...
              itels-center bg-[rgba(0, 0, 0, 0.5)] rounded-lg">
                <Loader />
              </div> )}
            </div>
          </div>
